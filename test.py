...
def main(config):
  ...
  agent.load_state_dict(torch.load('/data/mtpan/code_nips2024/dreamerv2-pure/log_offline/plate_slide_wm_first_7_50k/latest_model_200000.pt'))   ## /data/mtpan/code_icml2024/dreamer_offline/log_offline/door_close_2/latest_model_100000.pt
  ...
  #   print(agent._step)
  #   if agent._step % 30000 == 0 and agent._step != 0:
  ...
  test_root = pathlib.Path('/data/mtpan/code_icml2024/dreamer_pretrain/datasets_10_dreamerv3_200eps/plate_slide/eval_eps').expanduser()
  # test_root = pathlib.Path('/data/mtpan/code_nips2024/dreamerv2-pure/log_test/eval_model').expanduser()
  test_eps = tools.load_episodes(test_root, limit=config.dataset_size)
  test_dataset = make_dataset(test_eps, config)
